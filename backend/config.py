...
class APIConfig:
    ...
    DEFAULT_BAILIAN_ENDPOINT = "https://coding.dashscope.aliyuncs.com/v1"
    DEFAULT_BAILIAN_API_KEY = ""
    DEFAULT_BAILIAN_MODEL = "qwen3-max-2026-01-23"
    ...
    DEFAULT_MODEL = os.getenv(
        "DEFAULT_MODEL",
        os.getenv("BAILIAN_DEFAULT_MODEL", DEFAULT_BAILIAN_MODEL),
    )
    ...
    BAILIAN_DEFAULT_MODEL = os.getenv("BAILIAN_DEFAULT_MODEL", DEFAULT_BAILIAN_MODEL)
...
class AppConfig:
    ...
    POST_GAME_PER_AGENT_TIMEOUT_SECONDS = int(os.getenv("POST_GAME_PER_AGENT_TIMEOUT_SECONDS", "30"))
...
def validate_config(api_provider: str | None = None) -> bool:
    ...
    api_provider = api_provider or APIConfig.DEFAULT_API_PROVIDER
